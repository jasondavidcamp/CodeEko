...
export const actionSchema = z.union([
  ...
  action('apply_patch', { path, expectedHash: expectedHash.optional(), edits: z.array(z.object({ oldText: z.string().max(12000), newText: z.string().max(12000) }).strict()).min(1).max(10) }),
