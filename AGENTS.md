...
The established repository is `llm-coding-agent-runtime`. Use the product name established in current metadata. Do not rename the package, commands, settings, or publisher as part of unrelated work.
