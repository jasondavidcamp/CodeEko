...
- [Get started](docs/GETTING_STARTED.md) — prerequisites, build from source, install, and connect.
- [Usage](docs/USAGE.md) — chat, settings, permissions, and troubleshooting.
- [Development](docs/DEVELOPMENT.md) — build, test, and package.
- [Roadmap](ROADMAP.md) — progress and remaining work.
